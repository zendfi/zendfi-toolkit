...
subAccountsCmd
  ...
  .requiredOption('--bank-id <bankId>', 'Bank identifier (PAJ id, bank code, or bank name)')
  .option('--bank <bankIdentifier>', 'Alias for --bank-id')
...
subAccountsCmd
  ...
  .option('--bank-ids <ids>', 'Comma-separated allowed bank identifiers (must match request values exactly)')
